  ...
  head: () => {
    ...
    return {
      ...
      links: [
        ...
        { rel: "icon", href: "/favicon_1.ico", sizes: "48x48" },
        { rel: "icon", type: "image/png", sizes: "16x16", href: "/logo_red_16.png" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "/logo_red_32.png" },
